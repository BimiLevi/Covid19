...
2. **Analysis**
  ...
  * Creating a Jupiter notebook analysis format for Countries and Continents, including visualizations (Matplotlib, Plotly)
     Country Notebook:https://nbviewer.jupyter.org/github/BimiLevi/Covid19/blob/master/analysis/country_analysis.ipynb
     Continent Notebook:https://nbviewer.jupyter.org/github/BimiLevi/Covid19/blob/master/analysis/continent_analysis.ipynb
